...
public class SdxRepairTestDto extends AbstractSdxTestDto<SdxRepairRequest, SdxClusterDetailResponse, SdxRepairTestDto> {
    ...
    private static final String HOSTGROUP_NAME = HostGroupType.MASTER.getName();
    ...
    public SdxRepairTestDto valid() {
        withName(resourceProperyProvider().getName()).withHostGroupName(HOSTGROUP_NAME);
    ...
    public SdxRepairTestDto withName(String name) {
        setName(name);
        return this;
    }
