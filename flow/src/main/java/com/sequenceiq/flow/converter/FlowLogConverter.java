...
public class FlowLogConverter extends AbstractConversionServiceAwareConverter<FlowLog, FlowLogResponse> {
    ...
    public FlowLogResponse convert(FlowLog source) {
        ...
        flowLogResponse.setFlowType(source.getFlowType());
        flowLogResponse.setResourceId(source.getResourceId());
        flowLogResponse.setResourceType(source.getResourceType());
        flowLogResponse.setNextEvent(source.getNextEvent());
        flowLogResponse.setPayload(source.getPayload());
        flowLogResponse.setPayloadType(source.getPayloadType());
        flowLogResponse.setVariables(source.getVariables());
        ...
        flowLogResponse.setVersion(source.getVersion());
